...
import yaml
from conftest import COPIER, ROOT, VERSION, Feedstock
...
def test_generated_renovate_config_leaves_the_copier_owned_pins_alone(
    ...
    # A rule matching nothing protects nothing, so check both pins are really there.
    assert (
        "climate-resource/copier-bookshelf-dataset/.github/workflows/"
        in feedstock.read(".github/workflows/feedstock-ci.yaml")
    )
    assert '"bookshelf[publish,dataframes]==' in feedstock.read("pyproject.toml")
